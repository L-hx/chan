...
public class Lock10 implements Runnable{
	private JFrame L=new JFrame("你确定吗？");//一个面板罢了
	private JFrame J = new JFrame("锁");//锁屏界面的面板
	private JButton M=new JButton("解锁密锁");//密码按钮
	...
	public void lock(){
		...
		J.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				J.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);//调用任意已注册 WindowListener 的对象后自动隐藏并释放该窗体。 
			}
		});
	}
	//关于窗口事件部分代码
